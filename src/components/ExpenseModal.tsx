...
interface Props {
  expense?: Expense;           // якщо передано — режим редагування
  onClose: () => void;
}

export default function ExpenseModal({ expense, onClose }: Props) {
  const { addExpense, updateExpense, state, currentUser } = useAppContext();
  ...
  const [currency, setCurrency] = useState<'UAH' | 'USD' | 'EUR'>(
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-lg border border-gray-200 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 text-sm transition"
              autoFocus
            />
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="w-28">
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-200 outline-none focus:border-blue-500 text-sm bg-white"
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-3 py-2 rounded-lg border border-gray-200 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 text-sm resize-none transition"
            />
          </div>
